	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="mission/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="p_id" value="${id }">
					<input type="hidden" name="user_id" value="${sessionScope['User']['id'] }">
					<ul class="forminfo">
						<li><label>进度名称<b>*</b></label><input id="name" 
						...
						<li><label>进度简介<b>*</b></label><textarea id="content7" name="content"></textarea></li>
