	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="cost/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${cost['id'] }">
					<ul class="forminfo">
						<li><label>成本金额<b>*</b></label><input id="price" value="${cost['price'] }"
							name="price" type="text" class="dfinput" placeholder="请填写成本金额"
							style="width: 518px;" /></li>
						<li><label>备注<b>*</b></label><textarea id="content7" name="content">${cost['content'] }</textarea></li>
