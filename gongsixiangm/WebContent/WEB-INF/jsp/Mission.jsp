	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="mission/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${mission['id'] }">
					<ul class="forminfo">
						<li><label>进度名称<b>*</b></label><input id="name"  value="${mission['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写进度名称"
							style="width: 518px;" /></li>
						<li><label>进度状态<b>*</b></label><div class="vocation"> <c:if test="${message!=null }">
								<c:out value="${message }"></c:out>
							</c:if> <select class="select3" name="status" id="status">
									...
									<c:if test="${mission['status'] eq 1}" var="s2">
						...
						<li><label>进度简介<b>*</b></label><textarea id="content7" name="content">${mission['content'] }</textarea></li>
						<c:if test="${sessionScope['User']['id'] eq mission['userInfo']['id']}">
