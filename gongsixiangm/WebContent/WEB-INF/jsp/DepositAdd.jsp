	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="deposit/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>项目名称<b>*</b></label><div class="vocation"> <c:if test="${message!=null }">
								<c:out value="${message }"></c:out>
							</c:if> <select class="select3" name="p_id" id="p_id">
								<c:forEach items="${projectList }" var="project">
									<option value="${project['id'] }">${project['name'] }</option>
								</c:forEach>
						</select></div></li>
						<li><label>押金金额<b>*</b></label><input id="price" 
							name="price" type="text" class="dfinput" placeholder="请填写押金金额"
