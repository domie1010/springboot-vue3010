		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="pay/informationAdd" method="POST"
					...
					<ul class="forminfo">
						<li><label>开支项目<b>*</b></label><div class="vocation"> <c:if test="${message!=null }">
						...
						<li><label>开支金额<b>*</b></label><input id="price" 
							name="price" type="text" class="dfinput" placeholder="请填写开支金额"
