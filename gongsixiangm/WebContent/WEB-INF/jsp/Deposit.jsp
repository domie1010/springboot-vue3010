	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="deposit/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${deposit['id'] }">
					<ul class="forminfo">
						<li><label>押金金额<b>*</b></label><input id="price" value="${deposit['price'] }"
							name="price" type="text" class="dfinput" placeholder="请填写押金金额"
							style="width: 518px;" /></li>
						<li><label>备注<b>*</b></label><textarea id="content7" name="content">${deposit['content'] }</textarea></li>
