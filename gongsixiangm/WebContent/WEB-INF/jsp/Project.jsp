	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="project/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${project['id'] }">
					<ul class="forminfo">
						<li><label>项目名称<b>*</b></label><input id="name" value="${project['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写项目名称"
							style="width: 518px;" /></li>
						<li><label>项目预算<b>*</b></label><input id="price" value="${project['price'] }"
							name="price" type="text" class="dfinput" placeholder="请填写项目预算"
							style="width: 518px;" /></li>
