	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="company/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${company['id'] }">
					<ul class="forminfo">
						<li><label>供应商名称<b>*</b></label><input id="name" value="${company['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写供应商名称"
							style="width: 518px;" /></li>
						<li><label>供应商地址<b>*</b></label><input id="address" value="${company['address'] }"
							name="address" type="text" class="dfinput" placeholder="请填写供应商地址"
							style="width: 518px;" /></li>
						<li><label>供应商电话<b>*</b></label><input id="phone" value="${company['phone'] }"
							name="phone" type="text" class="dfinput" placeholder="请填写供应商电话"
							style="width: 518px;" /></li>
						<li><label>供应商邮箱<b>*</b></label><input id="email" value="${company['email'] }"
							name="email" type="text" class="dfinput" placeholder="请填写供应商邮箱"
							style="width: 518px;" /></li>
